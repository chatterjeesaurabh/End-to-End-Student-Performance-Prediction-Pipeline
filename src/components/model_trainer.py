...
class ModelTrainer:
    ...
    def initiate_model_trainer(self, train_array, test_array):
        try:
            ...
            # HYPERPARAMETER TUNING: test parameters for Grid Search Cross-Validation
            params={            
                "Decision Tree": {
            ...
            model_report:dict = evaluate_models(X_train, y_train, X_test, y_test, models, params)   # R2 Score  (definition in 'utils.py')
            ...
            save_object(            # save the best model as 'PKL' file in the 'artifacts' folder
